...
namespace AngularNetApi.Migrations
{
    ...
    [Migration("20240906122632_productType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.FiscalData", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FiscalDataId"));
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.Join.JoinProductIngredient", b =>
                {
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.Join.JoinStoreWeekDay", b =>
                {
                    b.Property<int>("JoinStoreWeekDayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JoinStoreWeekDayId"));
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.JoinStoreCategory", b =>
                {
                    b.Property<int>("JoinStoreCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JoinStoreCategoryId"));
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.ProductType", b =>
                {
                    b.Property<int>("ProductTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.UserProfile", b =>
                {
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.WorkingHour", b =>
                {
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.FiscalData", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.Store", null)
                        .WithOne("FiscalData")
                        .HasForeignKey("AngularNetApi.Core.Entities.FiscalData", "StoreId")
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.JoinStoreCategory", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.Product", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.Store", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.ApplicationUser", null)
                        .WithOne("Store")
                        .HasForeignKey("AngularNetApi.Core.Entities.Store", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.UserProfile", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("UserProfile")
                        .HasForeignKey("AngularNetApi.Core.Entities.UserProfile", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AngularNetApi.Core.Entities.WorkingHour", b =>
                {
                    b.HasOne("AngularNetApi.Core.Entities.Join.JoinStoreWeekDay", null)
                        .WithMany("WorkingHour")
                        .HasForeignKey("JoinStoreWeekDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
